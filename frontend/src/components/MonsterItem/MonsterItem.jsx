        ...
        <div className="bg-slate-800  rounded-md gap-2 flex items-center justify-between" > 
            ...
            <div className="gap-2 flex items-center">
                <div className=" rounded-l w-20">
                        <img src={getImage(monster.image_path)} alt={monster.display_name} className="sprite-borde object-contain mb-3"/>
                </div>
                ...
                <div className="flex flex-col w-full gap-1">
                    ...
                    <div className="flex items-center gap-2 w-full">
                            ...
                            <div className="flex items-center gap-1">
                                <img src={getImage("icons/icon_hp.png")} alt="" className="sprite-borde w-4 flex"/>
                                <p className="font-bold"> {monster.max_hp}</p>
                            </div>

                            <div className="flex items-center gap-1">
                                <img src={getImage("icons/icon_atk.png")} alt="" className="sprite-borde w-3 flex"/>
                                <p className="font-bold"> {monster.atk}</p>
                            </div>

                            <div className="flex items-center gap-1">
                                <img src={getImage("icons/icon_spd.png")} alt="" className="sprite-borde w-3 flex"/>
                                <p className="font-bold"> {monster.spd}</p>
                            </div>

                            <div className="flex items-center gap-1">
                                <img src={getImage("icons/icon_aim.png")} alt="" className="sprite-borde w-3 flex"/>
            ...
            <div className=" bg-indigo-600 text-gray-300 px-3 py-2 mr-3 rounded-full font-extrabold">
                <img src={getImage("icons/icon_arrow.png")} alt="" className="w-2"/>
            </div>
